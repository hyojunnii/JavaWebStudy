...
public class MemberVo {
	...
	//회원가입 생성자
	public MemberVo(String memberId, String memberPwd, String memberPwd2, String memberName, String memberPhone,
			String memberEmail, String memberAddr, String memberInterest) {
		this.id = memberId;
		this.pwd = memberPwd;
